      ...
      <header class="fixed w-full top-0 z-50 transition-all duration-300 bg-white/80 backdrop-blur-md border-b border-gray-100" id="main-header">
        <div class="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <nav class="hidden md:flex items-center gap-8">
            ...
            <a href="overview-map.html" class="text-gray-600 hover:text-brand-600 font-medium transition-colors">マップ検索</a>
            <a href="area.html" class="text-gray-600 hover:text-brand-600 font-medium transition-colors">エリア一覧</a>
        ...
        <div class="md:hidden hidden bg-white border-t border-gray-100 absolute w-full" id="mobile-menu">
          <div class="container mx-auto px-4 py-4 flex flex-col gap-4">
            ...
            <a href="overview-map.html" class="block py-2 text-gray-600 font-medium">マップ検索</a>
            <a href="area.html" class="block py-2 text-gray-600 font-medium">エリア一覧</a>
